...
class TestCRUD:
    ...
    def test_create_user(self):
        ...
        with patch('app.core.models.User.model_validate', return_value=mock_user):
            with patch('app.core.security.get_password_hash', return_value='hashed_password'):
                # Act
                user_create = UserCreate(username="testuser", email="test@example.com", password="password")
    ...
    def test_create_conversation(self):
        ...
        with patch('app.core.models.Conversation.model_validate', return_value=mock_conversation):
            # Act
    ...
    def test_get_conversation_by_id(self):
        ...
        # Act
        result = get_conversation_by_id(session=self.mock_session, conversation_id=self.conversation_id)
    ...
    def test_get_conversations_by_user_id(self):
        ...
        # Act
        result = get_conversations_by_user_id(session=self.mock_session, user_id=self.user_id)
    ...
    def test_check_conversation_exists(self):
        ...
        # Act
        result = check_conversation_exists(session=self.mock_session, conversation_id=self.conversation_id)
