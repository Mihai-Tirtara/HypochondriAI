 ...
 */
export const getUserByNameV1NameGet = <ThrowOnError extends boolean = false>(options: Options<GetUserByNameV1NameGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetUserByNameV1NameGetResponse, GetUserByNameV1NameGetError, ThrowOnError>({
        url: '/v1/name',
        ...options
    });
};
